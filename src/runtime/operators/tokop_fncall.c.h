...
void rt_op_fncall_handler(const ast_Identifier_t *module, const ast_Identifier_t *proc);
...
void rt_op_fncall(rt_Data_t *lhs, rt_Data_t *rhs) {
    ...
    rt_op_fncall_handler(lhs->data.proc.modulename, lhs->data.proc.procname);
